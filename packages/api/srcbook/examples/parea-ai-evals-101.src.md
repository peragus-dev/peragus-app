...
You'll need to set 2 environment variables in [/secrets](/secrets) before we start:
- `PAREA_API_KEY`, get one [here](https://docs.parea.ai/api-reference/authentication)
- `OPENAI_API_KEY`
...
const requiredEnvVars = ['PAREA_API_KEY', 'OPENAI_API_KEY'];
